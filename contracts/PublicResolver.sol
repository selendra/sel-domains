...
contract PublicResolver {
    ...
    uint256 constant private COIN_TYPE_SEL = 354;
     ...
     * @param addr The EVM address to set
     */
    function setAddr(bytes32 node, address addr) external authorised(node) {
        _addresses[node][COIN_TYPE_ETH] = addressToBytes(addr);
     ...
     * @param addr The address in bytes
     */
